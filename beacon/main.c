//Adopted from https://github.com/pcbreflux/espressif/blob/master/esp32/app/ble_app_eddystone/main/app_bt.c
...
static void hci_cmd_send_ble_set_adv_param(void)
{
    ...
    uint16_t sz = make_cmd_ble_set_adv_param(hci_cmd_buf, adv_intv_min, adv_intv_max, adv_type, own_addr_type, peer_addr_type, peer_addr, adv_chn_map, adv_filter_policy);
    esp_vhci_host_send_packet(hci_cmd_buf, sz);
}
...
static void hci_cmd_send_ble_set_adv_data(void)
{
    ...
    adv_data[12] = 0xF2;  // Beacons TX power at 0m
